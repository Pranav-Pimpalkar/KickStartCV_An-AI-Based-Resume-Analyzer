...
# sql connector
connection = pymysql.connect(host='localhost',port=3306,user='root',password='Sahil@123',db='sahil')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://www.uphilltech.com/" style="text-decoration: none; color: #021659;">Uphill Technologies Private Limited</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.subheader("**About The Tool - Kickstart Cv**")
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>root</b> as username and <b>Sahil@123</b> as password.<br/>
            It will load all the required stuffs and perform analysis.
        </p><br/><br/>

        <p align="justify">
            Built with 🤍 by 
            <a href="https://www.uphilltech.com/" style="text-decoration: none; color: grey;">Uphill Technologies Private Limited</a> through 
            <a href="https://sites.google.com/view/group-no-3/home?authuser=0" style="text-decoration: none; color: grey;">Tech Agents</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'root' and ad_password == 'Sahil@123':
